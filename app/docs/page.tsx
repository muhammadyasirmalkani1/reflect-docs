    ...
    <div className="py-8">
      ...
      <div className="mb-8">
        <p className="text-xl text-gray-300 mb-4">
          Welcome to the Reflect documentation. Here you'll find comprehensive
          guides and documentation to help you start working with Reflect as
          quickly as possible.
        </p>
        <p className="text-gray-400 mb-6">
          Reflect is an AI-powered note-taking and thinking tool designed to
          help you organize your thoughts, generate ideas, and make connections
          between concepts.
        </p>
        <div className="flex flex-wrap gap-4">
          ...
          >
            <Link href="/docs/features/ai-assistant">AI Chat</Link>
          </Button>
          <Button
            asChild
            variant="outline"
            className="border-purple-500/30 hover:bg-purple-500/10"
          >
            <Link href="/docs/advanced/keyboard-shortcuts">
              Keyboard Shortcuts
            </Link>
          </Button>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
        <div className="feature-card">
          ...
          <p className="text-gray-400 mb-4">
            New to Reflect? Start here to learn the basics and get up and
            running quickly.
          </p>
        ...
        <div className="feature-card">
          ...
          <p className="text-gray-400 mb-4">
            Explore Reflect's powerful features to get the most out of your
          ...
          <ul className="space-y-2 mb-4">
            ...
            <li>
              <Link
                ...
                className="text-purple-400 hover:text-purple-300 flex items-center"
              >
                AI <ArrowRight className="ml-1 h-3 w-3" />
              </Link>
            </li>
            <li>
              <Link
        ...
        <div className="feature-card">
          ...
          <p className="text-gray-400 mb-4">
            Take your Reflect experience to the next level with advanced
      ...
      <div className="feature-card">
        ...
        <p className="text-gray-400 mb-6">
          Learn how to use Reflect with these step-by-step video tutorials.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-black/50 rounded-lg overflow-hidden border border-purple-500/20">
            ...
            <div className="p-4">
              ...
              <p className="text-sm text-gray-400">
                Learn the basics of Reflect in this introductory tutorial.
              </p>
              <Button
                asChild
                variant="link"
          ...
          <div className="bg-black/50 rounded-lg overflow-hidden border border-purple-500/20">
            ...
            <div className="p-4">
              ...
              <p className="text-sm text-gray-400">
                Discover how to leverage Reflect's AI for better thinking.
              </p>
              <Button
                asChild
                variant="link"
